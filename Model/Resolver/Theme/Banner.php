...
class Banner implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        $visibilityTable  = $this->resourceConnection->getTableName('simiconnector_visibility');
        $bannerCollection = $this->collectionBanner->create()->addFieldToFilter('status', '1')
                                                   ->applyAPICollectionFilter($visibilityTable, $typeID, (int) $context->getExtensionAttributes()->getStore()->getId());
